...
@remote_repo_test
def test_checkout_commit(tmp_path):
...
@remote_repo_test
def test_read_file_from_private_repo():
    output = read_file_from_repo(
...
def test_read_file_from_repo_local():
    output = read_file_from_repo(
...
def test_checkout_commit_local(tmp_path):
    target_dir = tmp_path / "files"
    checkout_commit(
