...
from agent.lib import docker, docker_stats
...
def test_get_job_stats(docker_cleanup):
    ...
    docker.run(
        "os-job-test", ["ghcr.io/opensafely-core/busybox:latest", "sleep", "1000"]
    )
    docker.run("not-job", ["ghcr.io/opensafely-core/busybox:latest", "sleep", "1000"])
